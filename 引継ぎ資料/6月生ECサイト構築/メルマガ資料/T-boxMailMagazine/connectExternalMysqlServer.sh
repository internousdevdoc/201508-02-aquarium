...
## 外部サーバーへssh接続してsubject_sqlを実行し、実行結果をsubject.txtに出力する
...
## 外部サーバーへssh接続してsubject_sqlを実行し、実行結果をcontents.txtに出力する
...
## 外部サーバーへssh接続してsubject_sqlを実行し、実行結果をaddress.txtに出力する
